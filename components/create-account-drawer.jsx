...
const CreateAccountDrawer = ({children}) => {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen} className="overflow-y-scroll" >
  ...
  <DrawerContent>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
        ...
        <div className="flex items-center justify-between rounded-lg border p-3">
            ...
            <p className='text-muted-foreground text-sm'>This account will be selected by default for transaction</p>
            </div>
            <Switch id="isDefault"
        ...
        <div className="flex gap-4 pt-4">
            ...
            <Button disabled={createAccountLoading} type="submit" className="flex-1" >{ createAccountLoading ?<> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Creating... </>: "Create Account"}</Button>
        </div>
    </form>
    </div>
  </DrawerContent>
